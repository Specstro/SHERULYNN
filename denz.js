...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*_© Ryan_*", [{buttonId: 'igm', buttonText: {displayText: 'Instagram'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
break
		...
		MINAT PC OWNER SAJA`
 buttons = [
{buttonId: `menu`, buttonText: {displayText: 'BACK️'}, type: 1},
{buttonId:`donasi`,buttonText:{displayText:'DONASI'},type:1},
{buttonId: `owner`, buttonText: {displayText: 'OWNER'}, type: 1}
]
const btnskuy = {
